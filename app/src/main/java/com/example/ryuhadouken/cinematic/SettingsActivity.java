...
public class SettingsActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.widget.ArrayAdapter<String> spAdapter= new android.widget.ArrayAdapter<>(this, R.layout.support_simple_spinner_dropdown_item, elements);
        sp.setAdapter(spAdapter);

        android.widget.ArrayAdapter<String> spAdapter_bg= new android.widget.ArrayAdapter<>(this, R.layout.support_simple_spinner_dropdown_item, elements);
